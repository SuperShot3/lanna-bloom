...
**Same-day delivery** is often available for orders placed before **20:00 Chiang Mai time**, subject to bouquet availability, delivery capacity, and route planning. If same-day delivery is not possible, we will contact you to confirm the next available option, which may include delivery on the following day.
