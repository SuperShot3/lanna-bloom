...
const baseTranslations = {
  en: {
    ...
    buyNow: {
      ...
      dropPinPrompt: 'Double-click (or double-tap) the map to drop a pin, or paste a Google Maps link or coordinates below. Use + and − to zoom, then drag to move the view.',
      ...
      pasteMapsOrCoordsPlaceholder: 'Paste a Google Maps link or latitude, longitude',
  ...
  th: {
    ...
    buyNow: {
      ...
      dropPinPrompt: 'ดับเบิลคลิก (หรือแตะสองครั้ง) บนแผนที่เพื่อวางหมุด หรือวางลิงก์ Google Maps หรือพิกัดด้านล่าง ใช้ + และ − เพื่อซูม แล้วลากเพื่อเลื่อนมุมมอง',
      ...
      pasteMapsOrCoordsPlaceholder: 'วางลิงก์ Google Maps หรือละติจูด, ลองจิจูด',
...
const russianTranslations = {
  ...
  buyNow: {
    ...
    dropPinPrompt: 'Дважды нажмите на карту, чтобы поставить точку, или вставьте ссылку Google Maps или координаты ниже. + и − меняют масштаб, перетаскивание двигает карту.',
    ...
    pasteMapsOrCoordsPlaceholder: 'Вставьте ссылку Google Maps или широту, долготу',
