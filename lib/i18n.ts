...
const baseTranslations = {
  en: {
    ...
    premiumCheckout: {
      ...
      specificTimeBeforeOpen: 'This time is before delivery hours. Earliest is 09:00.',
  ...
  th: {
    ...
    premiumCheckout: {
      ...
      specificTimeBeforeOpen: 'เวลานี้ก่อนช่วงจัดส่ง เร็วสุดคือ 09:00',
    ...
    guides: {
      ...
      sameDayFlowerDeliveryChiangMai: {
        ...
        faq: [
          ...
          { q: 'มีเวลาตัดสำหรับจัดส่งวันเดียวไหม?', a: 'รับออเดอร์จัดส่งวันเดียวถึง 20:00 น. ตามเวลาไทย โดยขึ้นอยู่กับความพร้อมของดอกไม้และการจัดส่ง อาจจัดส่งหลัง 20:00 น. ได้ เวลาทำการจัดส่งคือ 09:00–20:00 หากไม่สามารถจัดส่งภายในวันได้ เราจะติดต่อคุณเพื่อยืนยันทางเลือกที่เร็วที่สุด ซึ่งอาจเป็นวันถัดไป' },
...
const chineseHongKongTranslations = {
  ...
  catalog: {
    ...
    closedForSameDay: '今日配送已截止',
    deliverySameDayOpens: '今日 09:00 起可即日配送',
    deliverySameDayNext: '下一次即日配送 09:00（{date}）',
    chatWithUs: '聯絡我們',
