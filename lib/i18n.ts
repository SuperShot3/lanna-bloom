...
const baseTranslations = {
  en: {
    ...
    buyNow: {
      ...
      dropPinPrompt: 'Optional. Click the map to drop a pin at the delivery spot. You can drag the pin to move it.',
    ...
    cart: {
      ...
      mapsPromptStep1: 'Tap the map to drop a pin at the delivery spot',
      mapsPromptStep2: 'Drag the pin if you need to move it',
  ...
  th: {
    ...
    buyNow: {
      ...
      dropPinPrompt: 'ไม่บังคับ คลิกแผนที่เพื่อวางหมุดที่จุดจัดส่ง สามารถลากหมุดเพื่อย้ายได้',
    ...
    cart: {
      ...
      mapsPromptStep1: 'แตะแผนที่เพื่อวางหมุดที่จุดจัดส่ง',
      mapsPromptStep2: 'ลากหมุดถ้าต้องการย้าย',
...
const russianTranslations = {
  ...
  buyNow: {
    ...
    dropPinPrompt: 'Необязательно. Нажмите на карту, чтобы поставить точку доставки. Точку можно перетащить.',
  ...
  cart: {
    ...
    mapsPromptStep1: 'Нажмите на карту, чтобы поставить точку доставки',
    mapsPromptStep2: 'Перетащите точку, если нужно сдвинуть её',
