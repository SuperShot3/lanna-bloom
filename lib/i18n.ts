...
const baseTranslations = {
  en: {
    ...
    footer: {
      ...
      businessBlurb:
        'Online flower and gift delivery in Chiang Mai and across Thailand. Order from anywhere in the world with secure international card payment.',
      openDaily: 'Open daily: 8:00–20:00',
      deliveryOnly: 'Delivery only — no walk-in shop.',
      contactChannelsLabel: 'Phone / WhatsApp / LINE:',
      whatsappLinkText: 'WhatsApp',
      deliveryAreasPrefix: 'Delivery areas:',
      andWord: 'and',
  ...
  th: {
    ...
    footer: {
      ...
      legalName: 'Lanna Bloom Flower Delivery',
      businessBlurb:
        'บริการส่งดอกไม้และของขวัญออนไลน์ในเชียงใหม่และทั่วไทย สั่งได้จากทุกที่ในโลก ชำระด้วยบัตรระหว่างประเทศอย่างปลอดภัย',
      openDaily: 'เปิดทุกวัน: 8:00–20:00',
      deliveryOnly: 'จัดส่งเท่านั้น — ไม่มีหน้าร้าน',
      contactChannelsLabel: 'โทรศัพท์ / WhatsApp / LINE:',
      whatsappLinkText: 'WhatsApp',
      deliveryAreasPrefix: 'พื้นที่จัดส่ง:',
      andWord: 'และ',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'ได้ค่ะ รับออเดอร์จัดส่งวันเดียวถึง {cutoff} น. ตามเวลาไทย โดยขึ้นอยู่กับความพร้อมของดอกไม้และการจัดส่ง อาจจัดส่งหลัง {cutoff} น. ได้ เวลาทำการจัดส่งคือ {start}–{end} น. หากไม่สามารถจัดส่งภายในวันได้ เราจะติดต่อคุณเพื่อยืนยันทางเลือกที่เร็วที่สุด จัดส่งด้วยรถยนต์หรือ Grab โดยขึ้นอยู่กับที่อยู่ ขนาดช่อ และความพร้อมของบริการ',
          },
          {
...
const russianTranslations = {
  ...
  footer: {
    ...
    businessInformation: 'Сведения о компании',
    legalName: 'Lanna Bloom Flower Delivery',
    businessBlurb:
      'Онлайн-доставка цветов и подарков в Чиангмае и по Таиланду. Заказывайте из любой страны мира — оплата международной картой защищена.',
    openDaily: 'Открыто ежедневно: 8:00–20:00',
    deliveryOnly: 'Только доставка — без магазина для посетителей.',
    contactChannelsLabel: 'Телефон / WhatsApp / LINE:',
    whatsappLinkText: 'WhatsApp',
    deliveryAreasPrefix: 'Зоны доставки:',
    andWord: 'и',
...
const chineseSingaporeTranslations = {
  ...
  footer: {
    ...
    legalName: 'Lanna Bloom Flower Delivery',
    businessBlurb:
      '在线鲜花与礼品配送，覆盖清迈及泰国各地。可从世界各地下单，支持安全的国际银行卡支付。',
    openDaily: '每日营业：8:00–20:00',
    deliveryOnly: '仅提供配送 — 无到店服务。',
    contactChannelsLabel: '电话 / WhatsApp / LINE：',
    whatsappLinkText: 'WhatsApp',
    deliveryAreasPrefix: '配送地区：',
    andWord: '和',
...
const chineseHongKongTranslations = {
  ...
  homeLanding: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: '有即日鮮花配送嗎？',
          a: '有。即日訂單接受至泰國時間 {cutoff}，視鮮花及配送供應而定。配送可能於 {cutoff} 後完成。營業配送時間為 {start}–{end}；若無法即日送達，我們會聯絡您確認下一個可行時段。視地址、花束大小及供應情況，以紅車或 Grab 安排配送。',
        },
        {
          q: '清邁哪些地區可以送達？',
  ...
  footer: {
    ...
    businessInformation: '商家資料',
    legalName: 'Lanna Bloom Flower Delivery',
    businessBlurb:
      '網上鮮花及禮品配送，覆蓋清邁及泰國各地。可從世界各地下單，支援安全的國際銀行卡付款。',
    openDaily: '每日營業：8:00–20:00',
    deliveryOnly: '只提供配送 — 沒有門市。',
    contactChannelsLabel: '電話 / WhatsApp / LINE：',
    whatsappLinkText: 'WhatsApp',
    deliveryAreasPrefix: '配送地區：',
    andWord: '及',
