...
export const ZONES_BY_DESTINATION: Record<DeliveryDestinationId, DeliveryZoneDef[]> = {
  CHIANG_MAI: [
    ...
    { id: 'cm-mae-hia', labelEn: 'Mae Hia', labelTh: 'แม่เหียะ', feeThb: 550 },
    ...
    { id: 'cm-hang-dong', labelEn: 'Hang Dong', labelTh: 'หางดง', feeThb: 600 },
    { id: 'cm-san-kamphaeng', labelEn: 'San Kamphaeng', labelTh: 'สันกำแพง', feeThb: 550 },
    { id: 'cm-mae-rim', labelEn: 'Mae Rim', labelTh: 'แม่ริม', feeThb: 900 },
  ...
  PAI: [
    { id: 'pai-wiang-tai', labelEn: 'Wiang Tai / Pai town', labelTh: 'เวียงใต้ / ตัวเมืองปาย', feeThb: 550 },
    { id: 'pai-wiang-nuea', labelEn: 'Wiang Nuea', labelTh: 'เวียงเหนือ', feeThb: 550 },
    { id: 'pai-mae-hi', labelEn: 'Mae Hi', labelTh: 'แม่ฮี้', feeThb: 550 },
    { id: 'pai-mae-na-toeng', labelEn: 'Mae Na Toeng', labelTh: 'แม่นาเติง', feeThb: 550 },
    { id: 'pai-thung-yao', labelEn: 'Thung Yao', labelTh: 'ทุ่งยาว', feeThb: 550 },
    { id: 'pai-mueang-paeng', labelEn: 'Mueang Paeng', labelTh: 'เมืองแปง', feeThb: 550 },
    { id: 'pai-pong-sa', labelEn: 'Pong Sa', labelTh: 'โป่งสา', feeThb: 550 },
  ],
  LAMPHUN: [
