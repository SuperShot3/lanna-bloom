...
const COPY: Record<'en' | 'th', FlowerDeliveryThailandCopy> = {
  en: {
    ...
    paiTitle: 'Pai',
    paiIntro:
      'Flower delivery for listed Pai areas — not province-wide Mae Hong Son. Delivery from ฿550. Shop below or tap Mae Hong Son on the coverage map, then choose your Pai area at checkout.',
    paiNote:
      'Choose Pai as your delivery destination at checkout, then select the area. Mae Hong Son town, Mae Sariang, Khun Yuam, and Pang Mapha are not on this map.',
  ...
  th: {
    ...
    paiTitle: 'ปาย',
    paiIntro:
      'จัดส่งดอกไม้ในย่านปายที่ระบุ — ไม่ครอบคลุมทั้งจังหวัดแม่ฮ่องสอน ค่าส่งเริ่มต้น ฿550 เลือกด้านล่างหรือแตะแม่ฮ่องสอนบนแผนที่พื้นที่บริการ แล้วเลือกย่านปายตอนชำระเงิน',
    paiNote:
      'เลือกปลายทางปายตอนชำระเงิน แล้วเลือกย่าน ตัวเมืองแม่ฮ่องสอน แม่สะเรียง ขุนยวม และปางมะผ้าไม่อยู่บนแผนที่นี้',
