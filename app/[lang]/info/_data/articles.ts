...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    title: 'Birthday Flowers to Thailand From Abroad',
    excerpt:
      'Sending birthday flowers to Thailand from overseas: timing tips, surprise delivery, and how to choose a birthday bouquet. For payment and checkout basics, see the general abroad guide.',
    titleTh: 'ส่งดอกไม้วันเกิดไปประเทศไทยจากต่างประเทศ',
    excerptTh:
      'ส่งดอกไม้วันเกิดไปประเทศไทยจากต่างประเทศ: เคล็ดลับเรื่องเวลา เซอร์ไพรส์ และการเลือกช่อวันเกิด สำหรับการชำระเงินและเช็กเอาต์ ดูคู่มือต่างประเทศทั่วไป',
  ...
  },
  {
    ...
    excerpt:
      'How we deliver in every zone we serve: service hours 09:00–20:00, same-day guidance for orders placed before 20:00 Chiang Mai time, zones and fees at checkout, peak celebration pricing on major holidays, contact via LINE/WhatsApp or temporary order-page chat, and what we need for a smooth delivery. If same-day delivery is not possible, we will contact you with the next available option. Custom requests or extra questions? Message us on LINE or WhatsApp.',
    titleTh: 'นโยบายการจัดส่ง',
    excerptTh:
      'สรุปการจัดส่งทุกโซนที่เราเปิดให้บริการ: เวลาให้บริการ 09:00–20:00 แนวทางจัดส่งภายในวันสำหรับออเดอร์ที่สั่งก่อน 20:00 น. ตามเวลาเชียงใหม่ โซนและค่าจัดส่งตอนเช็กเอาต์ ราคาช่วงเทศกาลสำคัญ การติดต่อผ่าน LINE/WhatsApp หรือแชทชั่วคราวในหน้าออเดอร์ และข้อมูลที่อยู่ที่ควรเตรียม หากไม่สามารถจัดส่งภายในวันได้ เราจะติดต่อคุณเพื่อแจ้งทางเลือกที่เร็วที่สุด ต้องการงานพิเศษหรือสอบถามเพิ่มเติม ทัก LINE หรือ WhatsApp ได้เลย',
    ...
    ctaLinks: [
      ...
      { label: 'Terms of Service', labelTh: 'ข้อกำหนดการให้บริการ', href: '/terms' },
    ],
  },
  {
  ...
  },
  {
    ...
    title: 'Send Flowers to Thailand From Abroad',
    excerpt:
      'How to send flowers to Thailand from another country: international card checkout, recipient details for hotels and homes, Thailand time zones, and delivery tips. Availability depends on the destination city.',
    titleTh: 'ส่งดอกไม้ไปประเทศไทยจากต่างประเทศ',
    excerptTh:
      'วิธีส่งดอกไม้ไปประเทศไทยจากต่างประเทศ: จ่ายบัตรต่างประเทศ รายละเอียดผู้รับสำหรับโรงแรมและบ้าน เขตเวลาไทย และเคล็ดลับจัดส่ง ความพร้อมขึ้นกับเมืองปลายทาง',
    publishedAt: '2026-07-10T00:00:00.000Z',
    featured: true,
    cover: {
      type: 'image',
      src: '/blog_images/buy-flowers-online/buy-flower-online-lannabloom.png',
      alt: 'Fresh flower bouquet from Lanna Bloom with laptop for ordering flower delivery in Thailand from abroad',
    },
    ctaLinks: [
      { label: 'Browse bouquets', labelTh: 'เลือกช่อดอกไม้', href: '/catalog' },
      {
      ...
      {
        label: 'Same-day Chiang Mai',
        labelTh: 'จัดส่งวันเดียวเชียงใหม่',
        href: '/info/same-day-flower-delivery-chiang-mai',
      },
      {
        label: 'Hotel delivery tips',
        labelTh: 'เคล็ดลับส่งโรงแรม',
        href: '/info/flower-delivery-to-hotels-chiang-mai',
      },
      { label: 'Delivery policy', labelTh: 'นโยบายจัดส่ง', href: '/info/delivery-policy' },
  ...
  },
  {
    ...
    title: 'Flowers for Men: Potted Orchids That Feel Right',
    excerpt:
      'Not sure what to send a man? Start with a potted orchid—less awkward than rose bouquets—plus bright sunflower and lily ideas for Chiang Mai delivery.',
    titleTh: 'ดอกไม้สำหรับผู้ชาย: กล้วยไม้กระถางที่ให้ความรู้สึกใช่',
    excerptTh:
      'ไม่แน่ใจว่าควรส่งอะไรให้ผู้ชาย? เริ่มจากกล้วยไม้กระถาง—เขินน้อยกว่าช่อกุหลาบ—พร้อมไอเดียทานตะวันและลิลลี่โทนสดใสสำหรับจัดส่งในเชียงใหม่',
    ...
    ctaTitle: 'Shop flowers for men',
    ctaTitleTh: 'เลือกดอกไม้สำหรับผู้ชาย',
    ctaLinks: [
      { label: 'Shop orchid plants', labelTh: 'ดูกล้วยไม้กระถาง', href: '/collections/orchids-chiang-mai' },
      { label: 'Yellow orchid plant', labelTh: 'กล้วยไม้เหลืองกระถาง', href: '/catalog/elegant-yellow-orchid-plant' },
      { label: 'Thai orchid in pot', labelTh: 'กล้วยไม้ไทยกระถาง', href: '/catalog/large-thai-orchid-in-pot' },
  ...
  },
  {
    ...
    ctaLinks: [
      ...
      {
        label: 'Clear delivery address tips',
        labelTh: 'เคล็ดลับที่อยู่จัดส่ง',
        href: '/info/flower-delivery-address-chiang-mai',
      },
      { label: 'Delivery policy', labelTh: 'นโยบายจัดส่ง', href: '/info/delivery-policy' },
      {
