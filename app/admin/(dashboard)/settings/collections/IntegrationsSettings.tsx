...
const INTEGRATIONS: {
...
}[] = [
  {
    ...
    envVars:
      'GOOGLE_ADS_DEVELOPER_TOKEN, GOOGLE_ADS_CLIENT_ID, GOOGLE_ADS_CLIENT_SECRET, GOOGLE_ADS_REFRESH_TOKEN, GOOGLE_ADS_CUSTOMER_ID, GOOGLE_ADS_LOGIN_CUSTOMER_ID (optional MCC)',
  },
  {
    key: 'ga4',
    name: 'GA4 Data API',
    powers: 'Diagnostics, Funnel tab, tracking health checks',
    envVars:
      'GA4_PROPERTY_ID, GOOGLE_SERVICE_ACCOUNT_JSON (or GOOGLE_SERVICE_ACCOUNT_EMAIL + GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY)',
  },
  {
    key: 'llm',
    name: 'OpenAI',
...
export function IntegrationsSettings() {
  ...
  return (
    <section className="admin-accounting-info-section">
      <h2 className="admin-accounting-info-heading">Marketing &amp; analytics integrations</h2>
              ...
              {INTEGRATIONS.map((row) => (
                <tr key={row.key}>
                  ...
                  <td style={{ verticalAlign: 'top' }}>
                    <IntegrationStatusBadge ok={config[row.key]} />
                  </td>
                </tr>
              ))}
            </tbody>
      ...
      <ul style={{ margin: '16px 0 0', paddingLeft: 20, lineHeight: 1.6 }}>
        <li>Set variables in your hosting provider (e.g. Vercel → Environment Variables).</li>
