      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `html{background:#FDFCF8}html.dark{background:#0D1F1A}img{max-width:100%;height:auto}.storefront-icon{display:inline-block;flex-shrink:0;width:1.25em;height:1.25em;vertical-align:middle;background-color:currentColor;-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center}img:not([width]):not([style*="position:absolute"]):not([style*="position: absolute"]){max-width:min(100%,8rem);max-height:8rem;object-fit:contain}.hero-carousel-stage{min-height:22.5rem}.hero-slide-frame{width:17rem;height:22.5rem}@media(min-width:640px){.hero-carousel-stage{min-height:24rem}.hero-slide-frame{width:18rem;height:24rem}}@media(min-width:768px){.hero-slide-frame{width:21rem;height:420px}}@media(min-width:1024px){.hero-slide-frame{width:24rem}}`,
          }}
        />
