...
export function HeroFeatureCarousel({
  ...
  const spreadPercent = isMdUp ? 45 : 26;
          ...
          {images.map((image, index) => {
            ...
            return (
              <div
                key={`${image.src}-${index}`}
                className={cn(
                  'absolute w-[17rem] h-[22.5rem] sm:w-72 sm:h-96 md:w-[21rem] md:h-[420px] lg:w-96 lg:h-full transition-all duration-500 ease-in-out',
